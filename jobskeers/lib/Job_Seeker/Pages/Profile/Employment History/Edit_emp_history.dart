...
class Edit_emp_history extends StatefulWidget {
  const Edit_emp_history({super.key});

  @override
  State<Edit_emp_history> createState() => _Edit_emp_historyState();
}

class _Edit_emp_historyState extends State<Edit_emp_history> {

  final TextEditingController companyNameController = TextEditingController(text: "");
  final TextEditingController companyBusinessController = TextEditingController(text: "");
  final TextEditingController companyLocationController = TextEditingController(text: "");
  final TextEditingController companyDesignationController = TextEditingController(text: "");
  final TextEditingController companyDepartmentController = TextEditingController(text: "");
  final TextEditingController companyResponsibilitiesController = TextEditingController(text: "");
  final TextEditingController companyHistoryStartDateController = TextEditingController(text: "");
  final TextEditingController companyHistoryEndDateController = TextEditingController(text: "");
  final TextEditingController areaOfExpertiseController = TextEditingController(text: "");
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text("Edit Employe History"),
          leading: IconButton(
