...
//             "email": UserEmailTextEditingController.text.trim(),
//             "phone": UserPhoneNumberTextEditingController.text.trim(),
//             "address": UserAddressTextEditingController.text.trim(),
//           };
//
...
//             Column(
//               children: [
//                 Image.asset(darktheme? "image/multitasking.png": "image/multitasking.png"),
//
//                 SizedBox(height: 20,),
//
//                 Text(
...
//                                       ),
//                                     ),
//                                     prefixIcon: Icon(Icons.person, color: darktheme? Colors.white : Colors.teal.shade400)
//                                 ),
...
//                                       ),
//                                     ),
//                                     prefixIcon: Icon(Icons.house, color: darktheme? Colors.white : Colors.teal.shade400)
//                                 ),
//                                 autovalidateMode: AutovalidateMode.onUserInteraction,
//                                 validator: (text){
//                                   if (text == null || text.isEmpty){
...
//                                       ),
//                                     ),
//                                     prefixIcon: Icon(Icons.password_sharp, color: darktheme? Colors.white : Colors.teal.shade400),
//                                     suffixIcon:IconButton (
//                                       icon: Icon(
